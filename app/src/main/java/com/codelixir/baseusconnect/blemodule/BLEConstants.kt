...
class BLEConstants {
    ...
    companion object {
        const val ACTION_GATT_CONNECTED = "com.codelixir.baseusconnec.ACTION_GATT_CONNECTED" //Strings representing actions to broadcast to activities
        const val ACTION_GATT_DISCONNECTED = "com.codelixir.baseusconnec.ACTION_GATT_DISCONNECTED" // Old com.zco.ble
        const val ACTION_GATT_SERVICES_DISCOVERED = "ccom.codelixir.baseusconnec.ACTION_GATT_SERVICES_DISCOVERED"
